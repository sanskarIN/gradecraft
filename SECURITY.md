...
- Exported spreadsheet cells are neutralized when they begin with common formula prefixes.
...
- Backup passphrases are not persisted by GradeCraft and are not included in exported files.
