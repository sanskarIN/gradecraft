...
3. Confirm README, privacy, security, setup, testing, and architecture documentation still match the implementation.
...
`npm run verify` includes TypeScript, ESLint, repository format checks, Markdown-link checks, secret scanning, unit/component tests with coverage, and the production build.
...
4. The release workflow builds the PWA and attaches a zip to the GitHub release.
