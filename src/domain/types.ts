...
export interface Course { id:string; name:string; code:string; color:string; creditHours:number; mode:CourseMode; scaleId:string; categories:Category[]; assignments:Assignment[]; createdAt:string; updatedAt:string; }
export interface Settings { theme:ThemePreference; reducedMotion:boolean; compactMode:boolean; onboardingComplete:boolean; }
