...
export function createDefaultData(now=new Date().toISOString()):AppData{return{schemaVersion:1,courses:[],gradeScales:[structuredClone(DEFAULT_SCALE)],settings:{theme:"system",language:"en",reducedMotion:false,compactMode:false,onboardingComplete:false},lastUpdatedAt:now};}
