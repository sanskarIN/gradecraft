...
**GradeCraft** is a privacy-first, offline-capable student grade calculator built as a TypeScript + React progressive web app. It supports weighted and points-based grading, what-if planning, custom GPA scales, charts, backups, CSV transfer, and accessible keyboard-friendly workflows.
...
TypeScript, React 19, Vite, Vitest, Testing Library, Playwright, ESLint, GitHub Actions, CodeQL, browser Local Storage, and Service Worker APIs.
